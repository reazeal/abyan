...
class Relasi_model extends MY_Model
{
    ...
    public $column_order = array(null, 'id','kode_relasi','nama_relasi','alamat_relasi','jenis','nomor_telp',null);
    public $column_search = array('id','kode_relasi','nama_relasi','alamat_relasi','jenis','nomor_telp');
    ...
    {
        $this->db->from($this->table);
        $this->db->where('kode_relasi',$kode);
        $query = $this->db->get();
