            ...
            foreach ($query->result() as $atributy) {
                ...
                if($atributy->terima == 0){
                    ...
                    $data[] = array(
                        ...
                        'action' => '
                            <a class="btn btn-sm btn-success terima-detail" href="javascript:void(0)" title="Terima" onclick="update_po('."'".$atributy->id."'".')"><i class="glyphicon glyphicon-check"></i> Edit</a>
                            <a class="btn btn-sm btn-success terima-detail" href="javascript:void(0)" title="Terima" onclick="terima_po('."'".$atributy->id."'".')"><i class="glyphicon glyphicon-check"></i> Terima</a>'    
