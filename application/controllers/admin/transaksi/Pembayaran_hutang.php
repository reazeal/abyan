 ...
 */
class Pembayaran_hutang extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->render('admin/transaksi/Pembayaran_hutang_view');
    }
    ...
    public function get_data_all(){
        ...
        $list = $this->pembayaran_hutang_model->get_datatables();
        $data = array();
        ...
        $output = array(
            ...
            "recordsTotal" => $this->pembayaran_hutang_model->count_all(),
            "recordsFiltered" => $this->pembayaran_hutang_model->count_filtered(),
            "data" => $data,
        );
    ...
    public function add()
    {
        ...
        $kode = $kode_awal."/BH/".$tanggal_asli[1]."/".$tanggal_asli[0];

        $id = md5($kode.'pembayaran-hutang'.$rand.$this->input->post('kode_hutang').date('YmdHis'));

        $data = array(
            'id' => $id,
            'kode_pembayaran_hutang' => $kode,
