...
<footer>
    <div class="pull-right">
        &copy; <a href="#" onclick="showCredit(CREDIT,WEB_TITLE);"><?php echo $copyright; ?>
    </div>
...
<script src="<?php echo site_url('assets/jqueryui/jquery.printarea.js');?>"></script>
<script src="<?php echo site_url('assets/jqueryui/eModal.min.js');?>"></script>
<script src="<?php echo site_url('assets/jqueryui/credit.js');?>"></script>
<script src="<?php echo site_url('assets/jqueryui/icheck.min.js');?>"></script>
<script src="<?php echo site_url('assets/jqueryui/jquery.ajax-combobox.js');?>"></script>
<script src="<?php echo site_url('assets/jqueryui/jquery.simple-scroll-follow.min.js');?>"></script>

<!-- Custom Theme Scripts -->
<script src="<?php echo site_url('assets/build/js/custom.js');?>"></script>
