    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Form Prameter</h3>
				</div>
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						<div class="form-body">
							<div class="form-group">
								<label class="control-label col-md-3">Tgl. Awal<span class="required">*</span></label>
								<div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Tgl. Akhir<span class="required">*</span></label>
                                <div class="col-md-9">
 ...
 function cetak()
    {
        ...
        eModal.iframe('<?php echo  site_url('admin/laporan/mutasi_barang/cetak');?>?tgl_awal='+$('#tgl_awal').val()+'&tgl_akhir='+ $('#tgl_akhir').val(), 'Laporan Mutasi Barang');
