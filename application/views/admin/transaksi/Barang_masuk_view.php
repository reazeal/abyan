...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#datatable-responsive').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/transaksi/barang_masuk/get_data_all');?>",
                "type": "POST"
            },
            buttons: [
                {
    ...
    function edit_barang_masuk(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/transaksi/barang_masuk/edit/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="nomor_referensi"]').val(data[0]['nomor_referensi']);
                 $('[name="jenis_trans"]').val(data[0]['jenis_trans']);
                ...
                <form action="#" id="form_edit" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nomor_referensi" placeholder="Nomor Referensi" class="validate[required,minSize[6]] form-control" type="text" required="required" data-validate-length-range="6" data-validate-words="2" readonly="true">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Jenis Trans <span class="required">*</span></label>
                            <div class="col-md-9">
                                <input name="jenis_trans" placeholder="Nomor Referensi" class="validate[required,minSize[6]] form-control" type="text" required="required" data-validate-length-range="6" data-validate-words="2" readonly="true">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <input name="kode_barang" placeholder="Keterangan" class="form-control" type="text" required="required" readonly="true">
                                <span class="help-block"></span>
                            </div>
                        </div>
