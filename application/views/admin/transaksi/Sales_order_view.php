                ...
                <form action="#" id="form_return" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">No. So <span class="required">*</span></label>
                            <div class="col-md-9">
                                <input name="kode_so" placeholder="Nomor So" class="validate[required,minSize[6]] form-control" type="text" required="required" data-validate-length-range="2" data-validate-words="2" readonly="true">
                                <span class="help-block"></span>
                            </div>
                        </div>
