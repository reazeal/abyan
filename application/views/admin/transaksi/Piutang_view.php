    ...
    function diskon(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Set Diskon'); // Set title to Bootstrap modal title
...
<div class="modal fade" id="modal_form_diskon" role="dialog" style="overflow-y: auto !important;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Form Diskon</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form_diskon" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">Nominal Diskon<span class="required">*</span></label>
                        <div class="col-md-6">
                            <input name="nominal_diskon" placeholder="Nominal Diskon" class="validate[required,custom[number]] form-control" type="text" required="required">
                            <span class="help-block"></span>
                            </div>
                    </div>
