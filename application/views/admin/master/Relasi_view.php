    ...
    function edit_relasi(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('[name="kode"]').val(data[0]['kode_relasi']);
                $('[name="nama"]').val(data[0]['nama_relasi']);
                $('[name="alamat"]').val(data[0]['alamat_relasi']);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kode" placeholder="Kode relasi" class="validate[required,minSize[3]] form-control" type="text" required="required" data-validate-length-range="6" data-validate-words="2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama" placeholder="Nama relasi" class="validate[required] form-control" type="text" required="required" data-validate-length-range="6" data-validate-words="2">
                                <span class="help-block"></span>
                            </div>
                        </div>
